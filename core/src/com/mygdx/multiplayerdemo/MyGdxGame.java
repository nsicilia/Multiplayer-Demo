...
// Before running this go to Terminal and cd into the server folder and type "node index.js"
// to kill server press control + c
...
public class MyGdxGame extends ApplicationAdapter {
    ...
    public void render () {
        ...
        batch.begin();
        //checks to see if there is a player on the server
        if(player != null){
            player.draw(batch);
        }
